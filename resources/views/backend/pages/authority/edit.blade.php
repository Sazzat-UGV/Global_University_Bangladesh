...
@endpush
@section('content')
    @include('backend.layout.inc.breadcump', ['page_name' => 'Authority Edit'])
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('authority.update', $authority->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label>Authority Type<span class="text-danger">*</span></label>
                                <select class="custom-select @error('authority_type') is-invalid @enderror"
                                    name="authority_type">
                                    <option value="Board of Trustees"
                                        {{ $authority->authority_type == 'Board of Trustees' ? 'selected' : '' }}>
                                        Board of Trustees</option>
                                    <option value="Syndicate Members"
                                        {{ $authority->authority_type == 'Syndicate Members' ? 'selected' : '' }}>
                                        Syndicate Members</option>
                                    <option value="Academic Members"
                                        {{ $authority->authority_type == 'Academic Members' ? 'selected' : '' }}>
                                        Academic Members</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="authority_name"
                                    ...
                                    is-invalid
                                    @enderror"
                                    id="authority_name" placeholder="enter authority name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="authority_designation"
                                    ...
                                    is-invalid
                                    @enderror"
                                    id="authority_designation" placeholder="enter authority designation"
                                    value="{{ $authority->authority_designation }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="authority_image"
                                    data-default-file="{{ asset('uploads/authority') }}/{{ $authority->authority_image }}"
